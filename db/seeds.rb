...
blueberry_pancakes = Recipe.new(recipe_name: 'Blueberry Pancakes')
...
blueberry_pancakes_ingredients.each{|i| blueberry_pancakes.ingredients.build(ingredients_name: i)}
